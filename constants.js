...
export const STATE = {
    screen: 'video', 
    room: 'ROOM_HALL',
    // Using object literal for position to avoid dependency issues during load
    pos: { x: 0, y: 1, z: 0 }, 
    target: null, 
    activeHotspot: null,
...
export const ROOM_DATA = {
    ROOM_HALL: {
        ...
        geometry: [
            ...
            { type: 'box', dim: [1, 4, 1], pos: [5, 2, -5], color: 0x3d2719, name: 'clock', hotspot: { type: 'inspect', id: 'gallery_model1', title: 'GRANDFATHER CLOCK', text: "The hands are stuck at a strange angle...", clueIdx: 0 } }
        ],
        hotspots: [
    ...
    ROOM_GALLERY: {
        ...
        geometry: [
            ...
            { type: 'box', dim: [2, 1, 2], pos: [0, 0.5, 0], color: 0x550000, name: 'pedestal', hotspot: { type: 'inspect', id: 'gallery_model1', title: 'CRIMSON ARTIFACT', text: "A strange, pulsating geometric shape.", clueIdx: 1 } }
        ],
        hotspots: [
    ...
    ROOM_ARCHIVE: {
        ...
        geometry: [
            ...
            { type: 'box', dim: [2, 2, 2], pos: [-5, 1, 0], color: 0x444444, name: 'files', hotspot: { type: 'text', id: 'archive_concept', title: 'LOGS', text: "System failing...", clueIdx: 2 } }
        ],
        hotspots: [
